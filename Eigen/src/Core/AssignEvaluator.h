...
struct copy_using_evaluator_traits {
 ...
 public:
  ...
  static void debug() {
    std::cerr << "DstXpr: " << typeid(typename DstEvaluator::XprType).name() << modm::endl;
    std::cerr << "SrcXpr: " << typeid(typename SrcEvaluator::XprType).name() << modm::endl;
    std::cerr.setf(std::ios::hex, std::ios::basefield);
    std::cerr << "DstFlags"
              << " = " << DstFlags << " (" << demangle_flags(DstFlags) << " )" << modm::endl;
    std::cerr << "SrcFlags"
              << " = " << SrcFlags << " (" << demangle_flags(SrcFlags) << " )" << modm::endl;
    ...
    std::cerr << "Traversal"
              << " = " << Traversal << " (" << demangle_traversal(Traversal) << ")" << modm::endl;
    ...
    std::cerr << "Unrolling"
              << " = " << Unrolling << " (" << demangle_unrolling(Unrolling) << ")" << modm::endl;
    std::cerr << modm::endl;
  }
#endif
};
